...
import { Lock, Eye, ShieldCheck, Database, Info } from "lucide-react";

export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Pay Tracker" },
      { name: "description", content: "Privacy Policy and user data protection details for Pay Tracker." },
    ],
  }),
    ...
    <AppShell variant={user ? "app" : "minimal"}>
      <div className="max-w-4xl mx-auto space-y-8 animate-fade-up py-4 px-2">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-foreground">{t("privacy_title")}</h1>
        ...
        <div className="space-y-6">
          <Card className="rounded-2xl border border-border bg-card shadow-card hover:shadow-pop transition-all duration-300">
            <CardHeader className="flex flex-row items-center gap-4 pb-3">
              ...
              <CardTitle className="text-lg font-bold">{t("privacy_sec1_title")}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {t("privacy_sec1_desc")}
          ...
          <Card className="rounded-2xl border border-border bg-card shadow-card hover:shadow-pop transition-all duration-300">
            <CardHeader className="flex flex-row items-center gap-4 pb-3">
              ...
              <CardTitle className="text-lg font-bold">{t("privacy_sec2_title")}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {t("privacy_sec2_desc")}
          ...
          <Card className="rounded-2xl border border-border bg-card shadow-card hover:shadow-pop transition-all duration-300">
            <CardHeader className="flex flex-row items-center gap-4 pb-3">
              ...
              <CardTitle className="text-lg font-bold">{t("privacy_sec3_title")}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {t("privacy_sec3_desc")}
          ...
          <Card className="rounded-2xl border border-border bg-card shadow-card hover:shadow-pop transition-all duration-300">
            <CardHeader className="flex flex-row items-center gap-4 pb-3">
              ...
              <CardTitle className="text-lg font-bold">{t("privacy_sec4_title")}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {t("privacy_sec4_desc")}
